...
def art():
    print(f"{Fore.LIGHTRED_EX}" + r""" _ __      _      __    _""" + f"{Style.RESET_ALL}")
    print(f"{Fore.GREEN}" + r"""|_   _|  _ \    / \  |  \/  |  / \ """ + f"{Style.RESET_ALL}")
    print(f"{Fore.MAGENTA}" + r"""  | | | |_) |  / _ \ | |\/| | / _ \ """ + f"{Style.RESET_ALL}")
    print(f"{Fore.LIGHTRED_EX}" + r"""  | | |  _ <  / _ \| |  | |/ _ \ """ + f"{Style.RESET_ALL}")
    print(f"{Fore.GREEN}" + r"""  |_| |_| \_\/_/   \_\_|  |_/_/   \_\ """ + f"{Style.RESET_ALL}")

    print(f"{Fore.CYAN + Style.BRIGHT}Join our Telegram: https://t.me/A_Airdrops{Style.RESET_ALL}\n")
